...
<title>Carrier Click - Home Page</title>
    ...
    <div id="slider_wrapper">
        <div id="slider">
		    ...
		    <a href="#"><img src="images/slideshow/02.jpg" alt="02" title="Nullam ante leo, consectetur eget adipiscing." /></a>-->
  			<a href="#"><img src="images/slideshow/07.jpg" alt="05" title="Welcomes to Carrier Click!" /></a>
 			<a href="#"><img src="images/slideshow/09.jpg" alt="05" title="Administrative Building" /></a>
			
		   <a href="#"><img src="images/slideshow/08.jpg" alt="05" title="Your Placements Solution is here..." /></a>
        ...
        <div class="col_w900">
          ...
          <div class="col_allw280 frontpage_box col_last">
			  ...
			  <form action="LoginTPS.jsp" name="login" method="post">
				<table border="0" ><tr><td>Enter Username:</td><td><input type="text" name="uname"></input></td></tr>
				...
				<tr><td colspan="2" align="center"><input type="submit" value="Login"/> <input style="margin-left: 5px;" type="reset" value="Clear" /> <a href="NewUser.jsp">Sign Up</a> </td>
				  </tr>
				</table>
			</form>
          </div>
        ...
        <div class="col_w900 col_w900_last">
          <div class="col_w420 float_l">
            ...
            <div class="col_w420 float_r">
                ...
                <div class="lbe_box">
                    <h3><a href="#">Campus Drive by Tata Consultancy Services....</a></h3>
                    <p class="date">Feb 28, 2023</p>
                </div>
                <div class="lbe_box">
                    <h3><a href="#">Campus Drive by Accenture.....</a></h3>
